...
Write-Host "Checking for updates (BADTOWN_Animal)..." -ForegroundColor Cyan

$apiUrl = "https://api.github.com/repos/GRILLYje/Animal_Badtown_Public/releases/latest"
...
$folderPath = Join-Path -Path $baseTemp -ChildPath "BADTOWN"
...
Write-Host "Launching BADTOWN_Animal..." -ForegroundColor Green
